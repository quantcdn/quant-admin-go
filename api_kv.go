...
type KVAPI interface {
	...
	*/
	...
	/*
	KVItemsPurge Delete items in bulk by prefix and/or age
	...
	@param project Project identifier
	@param storeId
	@return KVAPIKVItemsPurgeRequest
	*/
	KVItemsPurge(ctx context.Context, organization string, project string, storeId string) KVAPIKVItemsPurgeRequest

	// KVItemsPurgeExecute executes the request
	//  @return KVItemsPurge200Response
	KVItemsPurgeExecute(r KVAPIKVItemsPurgeRequest) (*KVItemsPurge200Response, *http.Response, error)
...
// Delete the store even if it still holds keys. Without it a non-empty store returns 409.
func (r KVAPIKVDeleteRequest) Force(force bool) KVAPIKVDeleteRequest {
	r.force = &force
	return r
}
...
type KVAPIKVItemsPurgeRequest struct {
	ctx context.Context
	ApiService KVAPI
	organization string
	project string
...
func (r KVAPIKVItemsPurgeRequest) Prefix(prefix string) KVAPIKVItemsPurgeRequest {
	r.prefix = &prefix
	return r
}

// Only delete keys last updated before this instant. ISO 8601, or a duration with unit s, m, h or d.
func (r KVAPIKVItemsPurgeRequest) OlderThan(olderThan string) KVAPIKVItemsPurgeRequest {
	r.olderThan = &olderThan
	return r
}

func (r KVAPIKVItemsPurgeRequest) Execute() (*KVItemsPurge200Response, *http.Response, error) {
	return r.ApiService.KVItemsPurgeExecute(r)
}
...
Deletes every item matching the filters. With no filters the whole store is cleared. A small purge finishes in the request and returns 200; a large one returns 202 with the counts so far and continues in the background. Idempotent.
 ...
 @return KVAPIKVItemsPurgeRequest
*/
func (a *KVAPIService) KVItemsPurge(ctx context.Context, organization string, project string, storeId string) KVAPIKVItemsPurgeRequest {
	return KVAPIKVItemsPurgeRequest{
		ApiService: a,
		ctx: ctx,
		organization: organization,
...
// Execute executes the request
//  @return KVItemsPurge200Response
func (a *KVAPIService) KVItemsPurgeExecute(r KVAPIKVItemsPurgeRequest) (*KVItemsPurge200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodDelete
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *KVItemsPurge200Response
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "KVAPIService.KVItemsPurge")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
