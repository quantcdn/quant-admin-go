...
// checks if the RuleServeStaticRequestUpdate type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RuleServeStaticRequestUpdate{}

// RuleServeStaticRequestUpdate struct for RuleServeStaticRequestUpdate
type RuleServeStaticRequestUpdate struct {
	...
	StaticFilePath *string `json:"static_file_path,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _RuleServeStaticRequestUpdate RuleServeStaticRequestUpdate
...
func NewRuleServeStaticRequestUpdate() *RuleServeStaticRequestUpdate {
	this := RuleServeStaticRequestUpdate{}
	var weight int32 = 0
	this.Weight = &weight
...
// GetStaticFilePath returns the StaticFilePath field value if set, zero value otherwise.
func (o *RuleServeStaticRequestUpdate) GetStaticFilePath() string {
	if o == nil || IsNil(o.StaticFilePath) {
		var ret string
		return ret
	}
...
// GetStaticFilePathOk returns a tuple with the StaticFilePath field value if set, nil otherwise
// and a boolean to check if the value has been set.
...
// SetStaticFilePath gets a reference to the given string and assigns it to the StaticFilePath field.
func (o *RuleServeStaticRequestUpdate) SetStaticFilePath(v string) {
	o.StaticFilePath = &v
}

func (o RuleServeStaticRequestUpdate) MarshalJSON() ([]byte, error) {
...
func (o RuleServeStaticRequestUpdate) ToMap() (map[string]interface{}, error) {
...
func (o *RuleServeStaticRequestUpdate) UnmarshalJSON(data []byte) (err error) {
	varRuleServeStaticRequestUpdate := _RuleServeStaticRequestUpdate{}

	err = json.Unmarshal(data, &varRuleServeStaticRequestUpdate)

	if err != nil {
		return err
	}

	*o = RuleServeStaticRequestUpdate(varRuleServeStaticRequestUpdate)
...
type NullableRuleServeStaticRequestUpdate struct {
	value *RuleServeStaticRequestUpdate
	isSet bool
}

func (v NullableRuleServeStaticRequestUpdate) Get() *RuleServeStaticRequestUpdate {
	return v.value
}

func (v *NullableRuleServeStaticRequestUpdate) Set(val *RuleServeStaticRequestUpdate) {
	v.value = val
	v.isSet = true
}

func (v NullableRuleServeStaticRequestUpdate) IsSet() bool {
	return v.isSet
}

func (v *NullableRuleServeStaticRequestUpdate) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRuleServeStaticRequestUpdate(val *RuleServeStaticRequestUpdate) *NullableRuleServeStaticRequestUpdate {
	return &NullableRuleServeStaticRequestUpdate{value: val, isSet: true}
}

func (v NullableRuleServeStaticRequestUpdate) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRuleServeStaticRequestUpdate) UnmarshalJSON(src []byte) error {
	v.isSet = true
