...
// checks if the V2RuleErrorPage type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &V2RuleErrorPage{}

// V2RuleErrorPage struct for V2RuleErrorPage
type V2RuleErrorPage struct {
	// Rule name
	...
	ActionConfig V2RuleErrorPageAction `json:"action_config"`
	AdditionalProperties map[string]interface{}
}

type _V2RuleErrorPage V2RuleErrorPage
...
func (o V2RuleErrorPage) MarshalJSON() ([]byte, error) {
...
func (o V2RuleErrorPage) ToMap() (map[string]interface{}, error) {
...
func (o *V2RuleErrorPage) UnmarshalJSON(data []byte) (err error) {
	...
	varV2RuleErrorPage := _V2RuleErrorPage{}

	err = json.Unmarshal(data, &varV2RuleErrorPage)

	if err != nil {
		return err
	}

	*o = V2RuleErrorPage(varV2RuleErrorPage)
...
type NullableV2RuleErrorPage struct {
	value *V2RuleErrorPage
	isSet bool
}

func (v NullableV2RuleErrorPage) Get() *V2RuleErrorPage {
	return v.value
}

func (v *NullableV2RuleErrorPage) Set(val *V2RuleErrorPage) {
	v.value = val
	v.isSet = true
}

func (v NullableV2RuleErrorPage) IsSet() bool {
	return v.isSet
}

func (v *NullableV2RuleErrorPage) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableV2RuleErrorPage(val *V2RuleErrorPage) *NullableV2RuleErrorPage {
	return &NullableV2RuleErrorPage{value: val, isSet: true}
}

func (v NullableV2RuleErrorPage) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableV2RuleErrorPage) UnmarshalJSON(src []byte) error {
	v.isSet = true
