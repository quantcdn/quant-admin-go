...
// checks if the V2RuleBotChallenge type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &V2RuleBotChallenge{}

// V2RuleBotChallenge struct for V2RuleBotChallenge
type V2RuleBotChallenge struct {
	// Error message
	...
	ActionConfig V2RuleBotChallengeAction `json:"action_config"`
	AdditionalProperties map[string]interface{}
}

type _V2RuleBotChallenge V2RuleBotChallenge
...
func (o *V2RuleBotChallenge) SetCacheLifetimeNil() {
...
func (o *V2RuleBotChallenge) SetNotifyConfigNil() {
...
func (o *V2RuleBotChallenge) SetQuantCloudSelectionNil() {
...
func (o *V2RuleBotChallenge) GetActionConfig() V2RuleBotChallengeAction {
	if o == nil {
		var ret V2RuleBotChallengeAction
		return ret
	}
...
func (o V2RuleBotChallenge) MarshalJSON() ([]byte, error) {
...
func (o V2RuleBotChallenge) ToMap() (map[string]interface{}, error) {
...
func (o *V2RuleBotChallenge) UnmarshalJSON(data []byte) (err error) {
	...
	varV2RuleBotChallenge := _V2RuleBotChallenge{}

	err = json.Unmarshal(data, &varV2RuleBotChallenge)

	if err != nil {
		return err
	}

	*o = V2RuleBotChallenge(varV2RuleBotChallenge)
...
type NullableV2RuleBotChallenge struct {
	value *V2RuleBotChallenge
	isSet bool
}

func (v NullableV2RuleBotChallenge) Get() *V2RuleBotChallenge {
	return v.value
}

func (v *NullableV2RuleBotChallenge) Set(val *V2RuleBotChallenge) {
	v.value = val
	v.isSet = true
}

func (v NullableV2RuleBotChallenge) IsSet() bool {
	return v.isSet
}

func (v *NullableV2RuleBotChallenge) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableV2RuleBotChallenge(val *V2RuleBotChallenge) *NullableV2RuleBotChallenge {
	return &NullableV2RuleBotChallenge{value: val, isSet: true}
}

func (v NullableV2RuleBotChallenge) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableV2RuleBotChallenge) UnmarshalJSON(src []byte) error {
	v.isSet = true
