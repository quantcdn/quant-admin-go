...
type AIInferenceAPI interface {
	...
	*/
	...
	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@param organisation The organisation ID
	@param identifier Either the requestId from async response, or full executionArn (URL-encoded)
	@return AIInferenceAPIGetDurableExecutionStatusRequest
	*/
	GetDurableExecutionStatus(ctx context.Context, organisation string, identifier string) AIInferenceAPIGetDurableExecutionStatusRequest

	// GetDurableExecutionStatusExecute executes the request
	//  @return GetDurableExecutionStatus200Response
	GetDurableExecutionStatusExecute(r AIInferenceAPIGetDurableExecutionStatusRequest) (*GetDurableExecutionStatus200Response, *http.Response, error)
	...
	*/
	...
	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@param organisation The organisation ID
	@return AIInferenceAPISubmitToolCallbackRequest
	*/
	SubmitToolCallback(ctx context.Context, organisation string) AIInferenceAPISubmitToolCallbackRequest

	// SubmitToolCallbackExecute executes the request
	//  @return SubmitToolCallback200Response
	SubmitToolCallbackExecute(r AIInferenceAPISubmitToolCallbackRequest) (*SubmitToolCallback200Response, *http.Response, error)
}
...
type AIInferenceAPIGetDurableExecutionStatusRequest struct {
	ctx context.Context
	ApiService AIInferenceAPI
	organisation string
	identifier string
...
func (r AIInferenceAPIGetDurableExecutionStatusRequest) Execute() (*GetDurableExecutionStatus200Response, *http.Response, error) {
	return r.ApiService.GetDurableExecutionStatusExecute(r)
}
...
Poll the status of an async/durable chat execution.
 ...
 @return AIInferenceAPIGetDurableExecutionStatusRequest
*/
func (a *AIInferenceAPIService) GetDurableExecutionStatus(ctx context.Context, organisation string, identifier string) AIInferenceAPIGetDurableExecutionStatusRequest {
	return AIInferenceAPIGetDurableExecutionStatusRequest{
		ApiService: a,
		ctx: ctx,
		organisation: organisation,
...
// Execute executes the request
//  @return GetDurableExecutionStatus200Response
func (a *AIInferenceAPIService) GetDurableExecutionStatusExecute(r AIInferenceAPIGetDurableExecutionStatusRequest) (*GetDurableExecutionStatus200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *GetDurableExecutionStatus200Response
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "AIInferenceAPIService.GetDurableExecutionStatus")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/v3/organizations/{organisation}/ai/chat/executions/{identifier}"
	localVarPath = strings.Replace(localVarPath, "{"+"organisation"+"}", url.PathEscape(parameterValueToString(r.organisation, "organisation")), -1)
...
type AIInferenceAPISubmitToolCallbackRequest struct {
	ctx context.Context
	ApiService AIInferenceAPI
	organisation string
...
func (r AIInferenceAPISubmitToolCallbackRequest) SubmitToolCallbackRequest(submitToolCallbackRequest SubmitToolCallbackRequest) AIInferenceAPISubmitToolCallbackRequest {
	r.submitToolCallbackRequest = &submitToolCallbackRequest
	return r
}

func (r AIInferenceAPISubmitToolCallbackRequest) Execute() (*SubmitToolCallback200Response, *http.Response, error) {
	return r.ApiService.SubmitToolCallbackExecute(r)
}
...
Submit tool execution results to resume a suspended durable execution.
 ...
 @return AIInferenceAPISubmitToolCallbackRequest
*/
func (a *AIInferenceAPIService) SubmitToolCallback(ctx context.Context, organisation string) AIInferenceAPISubmitToolCallbackRequest {
	return AIInferenceAPISubmitToolCallbackRequest{
		ApiService: a,
		ctx: ctx,
		organisation: organisation,
...
// Execute executes the request
//  @return SubmitToolCallback200Response
func (a *AIInferenceAPIService) SubmitToolCallbackExecute(r AIInferenceAPISubmitToolCallbackRequest) (*SubmitToolCallback200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *SubmitToolCallback200Response
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "AIInferenceAPIService.SubmitToolCallback")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/v3/organizations/{organisation}/ai/chat/callback"
	localVarPath = strings.Replace(localVarPath, "{"+"organisation"+"}", url.PathEscape(parameterValueToString(r.organisation, "organisation")), -1)

	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.submitToolCallbackRequest == nil {
		return localVarReturnValue, nil, reportError("submitToolCallbackRequest is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.submitToolCallbackRequest
	req, err := a.client.prepareRequest(r.ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, formFiles)
	if err != nil {
		return localVarReturnValue, nil, err
	}
