...
func Test_quant-admin-go_RulesProxyAPIService(t *testing.T) {
	...
	t.Run("Test RulesProxyAPIService RulesProxyDelete", func(t *testing.T) {
		...
		httpRes, err := apiClient.RulesProxyAPI.RulesProxyDelete(context.Background(), organization, project, rule).Execute()
