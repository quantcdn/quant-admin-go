...
// checks if the V2RuleServeStatic type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &V2RuleServeStatic{}

// V2RuleServeStatic struct for V2RuleServeStatic
type V2RuleServeStatic struct {
	// Error message
	...
	ActionConfig V2RuleServeStaticAction `json:"action_config"`
	AdditionalProperties map[string]interface{}
}

type _V2RuleServeStatic V2RuleServeStatic
...
func (o *V2RuleServeStatic) SetCacheLifetimeNil() {
...
func (o *V2RuleServeStatic) SetNotifyConfigNil() {
...
func (o *V2RuleServeStatic) SetQuantCloudSelectionNil() {
...
func (o *V2RuleServeStatic) GetActionConfig() V2RuleServeStaticAction {
	if o == nil {
		var ret V2RuleServeStaticAction
		return ret
	}
...
func (o V2RuleServeStatic) MarshalJSON() ([]byte, error) {
...
func (o V2RuleServeStatic) ToMap() (map[string]interface{}, error) {
...
func (o *V2RuleServeStatic) UnmarshalJSON(data []byte) (err error) {
	...
	varV2RuleServeStatic := _V2RuleServeStatic{}

	err = json.Unmarshal(data, &varV2RuleServeStatic)

	if err != nil {
		return err
	}

	*o = V2RuleServeStatic(varV2RuleServeStatic)
...
type NullableV2RuleServeStatic struct {
	value *V2RuleServeStatic
	isSet bool
}

func (v NullableV2RuleServeStatic) Get() *V2RuleServeStatic {
	return v.value
}

func (v *NullableV2RuleServeStatic) Set(val *V2RuleServeStatic) {
	v.value = val
	v.isSet = true
}

func (v NullableV2RuleServeStatic) IsSet() bool {
	return v.isSet
}

func (v *NullableV2RuleServeStatic) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableV2RuleServeStatic(val *V2RuleServeStatic) *NullableV2RuleServeStatic {
	return &NullableV2RuleServeStatic{value: val, isSet: true}
}

func (v NullableV2RuleServeStatic) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableV2RuleServeStatic) UnmarshalJSON(src []byte) error {
	v.isSet = true
