...
// checks if the V2RuleAuth type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &V2RuleAuth{}

// V2RuleAuth struct for V2RuleAuth
type V2RuleAuth struct {
	// Error message
	...
	ActionConfig V2RuleAuthAction `json:"action_config"`
	AdditionalProperties map[string]interface{}
}

type _V2RuleAuth V2RuleAuth
...
func (o *V2RuleAuth) SetCacheLifetimeNil() {
...
func (o *V2RuleAuth) SetNotifyConfigNil() {
...
func (o *V2RuleAuth) SetQuantCloudSelectionNil() {
...
func (o V2RuleAuth) MarshalJSON() ([]byte, error) {
...
func (o V2RuleAuth) ToMap() (map[string]interface{}, error) {
...
func (o *V2RuleAuth) UnmarshalJSON(data []byte) (err error) {
	...
	varV2RuleAuth := _V2RuleAuth{}

	err = json.Unmarshal(data, &varV2RuleAuth)

	if err != nil {
		return err
	}

	*o = V2RuleAuth(varV2RuleAuth)
...
type NullableV2RuleAuth struct {
	value *V2RuleAuth
	isSet bool
}

func (v NullableV2RuleAuth) Get() *V2RuleAuth {
	return v.value
}

func (v *NullableV2RuleAuth) Set(val *V2RuleAuth) {
	v.value = val
	v.isSet = true
}

func (v NullableV2RuleAuth) IsSet() bool {
	return v.isSet
}

func (v *NullableV2RuleAuth) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableV2RuleAuth(val *V2RuleAuth) *NullableV2RuleAuth {
	return &NullableV2RuleAuth{value: val, isSet: true}
}

func (v NullableV2RuleAuth) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableV2RuleAuth) UnmarshalJSON(src []byte) error {
	v.isSet = true
