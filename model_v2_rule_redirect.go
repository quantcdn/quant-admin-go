...
// checks if the V2RuleRedirect type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &V2RuleRedirect{}
...
type _V2RuleRedirect V2RuleRedirect
...
// SetActionConfig gets a reference to the given V2RuleRedirectAction and assigns it to the ActionConfig field.
func (o *V2RuleRedirect) SetActionConfig(v V2RuleRedirectAction) {
	o.ActionConfig = &v
}

func (o V2RuleRedirect) MarshalJSON() ([]byte, error) {
...
func (o *V2RuleRedirect) UnmarshalJSON(data []byte) (err error) {
	...
	varV2RuleRedirect := _V2RuleRedirect{}

	err = json.Unmarshal(data, &varV2RuleRedirect)

	if err != nil {
		return err
	}

	*o = V2RuleRedirect(varV2RuleRedirect)
...
type NullableV2RuleRedirect struct {
	value *V2RuleRedirect
	isSet bool
}

func (v NullableV2RuleRedirect) Get() *V2RuleRedirect {
	return v.value
}

func (v *NullableV2RuleRedirect) Set(val *V2RuleRedirect) {
	v.value = val
	v.isSet = true
}

func (v NullableV2RuleRedirect) IsSet() bool {
	return v.isSet
}

func (v *NullableV2RuleRedirect) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableV2RuleRedirect(val *V2RuleRedirect) *NullableV2RuleRedirect {
	return &NullableV2RuleRedirect{value: val, isSet: true}
}

func (v NullableV2RuleRedirect) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableV2RuleRedirect) UnmarshalJSON(src []byte) error {
	v.isSet = true
