...
type AIToolsAPI interface {
	...
	@return AIToolsAPIGetAIOrchestrationStatusRequest
	*/
	GetAIOrchestrationStatus(ctx context.Context, organisation string, orchestrationId string) AIToolsAPIGetAIOrchestrationStatusRequest

	// GetAIOrchestrationStatusExecute executes the request
	//  @return GetAIOrchestrationStatus200Response
	GetAIOrchestrationStatusExecute(r AIToolsAPIGetAIOrchestrationStatusRequest) (*GetAIOrchestrationStatus200Response, *http.Response, error)
	...
	*/
	...
	/*
	ListMcpServers List MCP servers with gateway URLs
	...
	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@param organisation The organisation ID
	@return AIToolsAPIListMcpServersRequest
	*/
	ListMcpServers(ctx context.Context, organisation string) AIToolsAPIListMcpServersRequest

	// ListMcpServersExecute executes the request
	//  @return ListMcpServers200Response
	ListMcpServersExecute(r AIToolsAPIListMcpServersRequest) (*ListMcpServers200Response, *http.Response, error)
}

// AIToolsAPIService AIToolsAPI service
type AIToolsAPIService service

type AIToolsAPIGetAIOrchestrationStatusRequest struct {
	ctx context.Context
...
func (r AIToolsAPIGetAIOrchestrationStatusRequest) Execute() (*GetAIOrchestrationStatus200Response, *http.Response, error) {
...
Retrieves the status and synthesized result of a multi-tool async execution orchestration.
 ...
 @return AIToolsAPIGetAIOrchestrationStatusRequest
*/
func (a *AIToolsAPIService) GetAIOrchestrationStatus(ctx context.Context, organisation string, orchestrationId string) AIToolsAPIGetAIOrchestrationStatusRequest {
	return AIToolsAPIGetAIOrchestrationStatusRequest{
		ApiService: a,
		ctx: ctx,
...
//  @return GetAIOrchestrationStatus200Response
func (a *AIToolsAPIService) GetAIOrchestrationStatusExecute(r AIToolsAPIGetAIOrchestrationStatusRequest) (*GetAIOrchestrationStatus200Response, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "AIToolsAPIService.GetAIOrchestrationStatus")
	if err != nil {
...
type AIToolsAPIListMcpServersRequest struct {
	ctx context.Context
	ApiService AIToolsAPI
	organisation string
}

func (r AIToolsAPIListMcpServersRequest) Execute() (*ListMcpServers200Response, *http.Response, error) {
...
Lists the organization's registered MCP servers for CLI sync (QuantCode). Each server's `url` is the FULL MCP gateway URL on the AI API host — clients connect there, never to the origin server. Credentials are never exposed.
 ...
 @return AIToolsAPIListMcpServersRequest
*/
func (a *AIToolsAPIService) ListMcpServers(ctx context.Context, organisation string) AIToolsAPIListMcpServersRequest {
	return AIToolsAPIListMcpServersRequest{
		ApiService: a,
		ctx: ctx,
		organisation: organisation,
...
// Execute executes the request
//  @return ListMcpServers200Response
func (a *AIToolsAPIService) ListMcpServersExecute(r AIToolsAPIListMcpServersRequest) (*ListMcpServers200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *ListMcpServers200Response
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "AIToolsAPIService.ListMcpServers")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/v3/organizations/{organisation}/ai/mcp-servers"
	localVarPath = strings.Replace(localVarPath, "{"+"organisation"+"}", url.PathEscape(parameterValueToString(r.organisation, "organisation")), -1)
