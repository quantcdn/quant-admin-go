...
type PatchEnvironmentComposeRequest struct {
	...
	// Forces single-task mode (max one running task). Omitted = auto-detect from stateful containers.
	SingleTaskOnly NullableBool `json:"singleTaskOnly,omitempty"`
	// Seconds the load balancer waits after a task starts before an unhealthy health check can replace it. Default 120.
	StartupGracePeriodSeconds NullableInt32 `json:"startupGracePeriodSeconds,omitempty"`
...
// GetSingleTaskOnly returns the SingleTaskOnly field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *PatchEnvironmentComposeRequest) GetSingleTaskOnly() bool {
	if o == nil || IsNil(o.SingleTaskOnly.Get()) {
		var ret bool
		return ret
	}
	return *o.SingleTaskOnly.Get()
}

// GetSingleTaskOnlyOk returns a tuple with the SingleTaskOnly field value if set, nil otherwise
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
...
// SetSingleTaskOnly gets a reference to the given NullableBool and assigns it to the SingleTaskOnly field.
func (o *PatchEnvironmentComposeRequest) SetSingleTaskOnly(v bool) {
	o.SingleTaskOnly.Set(&v)
}
// SetSingleTaskOnlyNil sets the value for SingleTaskOnly to be an explicit nil
func (o *PatchEnvironmentComposeRequest) SetSingleTaskOnlyNil() {
	o.SingleTaskOnly.Set(nil)
}
...
func (o *PatchEnvironmentComposeRequest) UnsetSingleTaskOnly() {
	o.SingleTaskOnly.Unset()
}

// GetStartupGracePeriodSeconds returns the StartupGracePeriodSeconds field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *PatchEnvironmentComposeRequest) GetStartupGracePeriodSeconds() int32 {
	if o == nil || IsNil(o.StartupGracePeriodSeconds.Get()) {
		var ret int32
		return ret
	}
	return *o.StartupGracePeriodSeconds.Get()
}

// GetStartupGracePeriodSecondsOk returns a tuple with the StartupGracePeriodSeconds field value if set, nil otherwise
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *PatchEnvironmentComposeRequest) GetStartupGracePeriodSecondsOk() (*int32, bool) {
	...
	return o.StartupGracePeriodSeconds.Get(), o.StartupGracePeriodSeconds.IsSet()
}
...
func (o *PatchEnvironmentComposeRequest) HasStartupGracePeriodSeconds() bool {
	if o != nil && o.StartupGracePeriodSeconds.IsSet() {
		return true
	}
...
// SetStartupGracePeriodSeconds gets a reference to the given NullableInt32 and assigns it to the StartupGracePeriodSeconds field.
func (o *PatchEnvironmentComposeRequest) SetStartupGracePeriodSeconds(v int32) {
	o.StartupGracePeriodSeconds.Set(&v)
}
// SetStartupGracePeriodSecondsNil sets the value for StartupGracePeriodSeconds to be an explicit nil
func (o *PatchEnvironmentComposeRequest) SetStartupGracePeriodSecondsNil() {
	o.StartupGracePeriodSeconds.Set(nil)
}
...
func (o *PatchEnvironmentComposeRequest) UnsetStartupGracePeriodSeconds() {
	o.StartupGracePeriodSeconds.Unset()
}
...
func (o PatchEnvironmentComposeRequest) ToMap() (map[string]interface{}, error) {
	...
	if o.SingleTaskOnly.IsSet() {
		toSerialize["singleTaskOnly"] = o.SingleTaskOnly.Get()
	}
	if o.StartupGracePeriodSeconds.IsSet() {
		toSerialize["startupGracePeriodSeconds"] = o.StartupGracePeriodSeconds.Get()
	}
	if o.Containers != nil {
...
func (o *PatchEnvironmentComposeRequest) UnmarshalJSON(data []byte) (err error) {
	...
	*o = PatchEnvironmentComposeRequest(varPatchEnvironmentComposeRequest)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "singleTaskOnly")
		delete(additionalProperties, "startupGracePeriodSeconds")
