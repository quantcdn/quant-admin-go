...
type RulesBotChallengeAPI interface {
	...
	*/
	...
	@param organization
	@param project
	@return RulesBotChallengeAPIRulesBotChallengeListRequest
	*/
	RulesBotChallengeList(ctx context.Context, organization string, project string) RulesBotChallengeAPIRulesBotChallengeListRequest
...
func (r RulesBotChallengeAPIRulesBotChallengeListRequest) Execute() ([]RuleBotChallenge, *http.Response, error) {
...
RulesBotChallengeList Method for RulesBotChallengeList
 ...
 @return RulesBotChallengeAPIRulesBotChallengeListRequest
*/
func (a *RulesBotChallengeAPIService) RulesBotChallengeList(ctx context.Context, organization string, project string) RulesBotChallengeAPIRulesBotChallengeListRequest {
	return RulesBotChallengeAPIRulesBotChallengeListRequest{
		ApiService: a,
		ctx: ctx,
		organization: organization,
...
// Execute executes the request
//  @return []RuleBotChallenge
func (a *RulesBotChallengeAPIService) RulesBotChallengeListExecute(r RulesBotChallengeAPIRulesBotChallengeListRequest) ([]RuleBotChallenge, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "RulesBotChallengeAPIService.RulesBotChallengeList")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
