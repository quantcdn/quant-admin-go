...
type ComposeAPI interface {
	...
	*/
	...
	@param application The application ID
	@param environment The environment ID
	@return ComposeAPIPatchEnvironmentComposeRequest
	*/
	PatchEnvironmentCompose(ctx context.Context, organisation string, application string, environment string) ComposeAPIPatchEnvironmentComposeRequest

	// PatchEnvironmentComposeExecute executes the request
	//  @return PatchEnvironmentCompose202Response
	PatchEnvironmentComposeExecute(r ComposeAPIPatchEnvironmentComposeRequest) (*PatchEnvironmentCompose202Response, *http.Response, error)
...
type ComposeAPIPatchEnvironmentComposeRequest struct {
	ctx context.Context
	ApiService ComposeAPI
	organisation string
	application string
	environment string
	patchEnvironmentComposeRequest *PatchEnvironmentComposeRequest
}

// Partial compose definition updates. All fields are optional.
func (r ComposeAPIPatchEnvironmentComposeRequest) PatchEnvironmentComposeRequest(patchEnvironmentComposeRequest PatchEnvironmentComposeRequest) ComposeAPIPatchEnvironmentComposeRequest {
	r.patchEnvironmentComposeRequest = &patchEnvironmentComposeRequest
	return r
}

func (r ComposeAPIPatchEnvironmentComposeRequest) Execute() (*PatchEnvironmentCompose202Response, *http.Response, error) {
	return r.ApiService.PatchEnvironmentComposeExecute(r)
}
...
Partially updates top-level fields of the environment's compose definition, such as architecture, task-level CPU/Memory, or min/max scaling capacity. Only fields included in the request body are modified. The 'containers' array, if provided, REPLACES the existing containers array; if omitted, the existing containers are NOT modified by this PATCH operation. (For modifying individual containers, use PATCH /containers/{containerName}). This triggers a validation, registers a new task definition, and updates the service.
 ...
 @return ComposeAPIPatchEnvironmentComposeRequest
*/
func (a *ComposeAPIService) PatchEnvironmentCompose(ctx context.Context, organisation string, application string, environment string) ComposeAPIPatchEnvironmentComposeRequest {
	return ComposeAPIPatchEnvironmentComposeRequest{
		ApiService: a,
		ctx: ctx,
		organisation: organisation,
...
// Execute executes the request
//  @return PatchEnvironmentCompose202Response
func (a *ComposeAPIService) PatchEnvironmentComposeExecute(r ComposeAPIPatchEnvironmentComposeRequest) (*PatchEnvironmentCompose202Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPatch
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *PatchEnvironmentCompose202Response
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ComposeAPIService.PatchEnvironmentCompose")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
	...
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.patchEnvironmentComposeRequest == nil {
		return localVarReturnValue, nil, reportError("patchEnvironmentComposeRequest is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.patchEnvironmentComposeRequest
	req, err := a.client.prepareRequest(r.ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, formFiles)
	if err != nil {
		return localVarReturnValue, nil, err
	}
