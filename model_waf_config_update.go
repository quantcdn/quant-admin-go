...
type WAFConfigUpdate struct {
	...
	Httpbl *WAFConfigUpdateHttpbl `json:"httpbl,omitempty"`
...
// SetHttpbl gets a reference to the given WAFConfigUpdateHttpbl and assigns it to the Httpbl field.
