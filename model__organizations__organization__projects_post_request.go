...
// checks if the OrganizationsOrganizationProjectsPostRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &OrganizationsOrganizationProjectsPostRequest{}

// OrganizationsOrganizationProjectsPostRequest struct for OrganizationsOrganizationProjectsPostRequest
type OrganizationsOrganizationProjectsPostRequest struct {
...
func NewOrganizationsOrganizationProjectsPostRequest() *OrganizationsOrganizationProjectsPostRequest {
	this := OrganizationsOrganizationProjectsPostRequest{}
	return &this
}
...
func (o OrganizationsOrganizationProjectsPostRequest) MarshalJSON() ([]byte, error) {
...
func (o OrganizationsOrganizationProjectsPostRequest) ToMap() (map[string]interface{}, error) {
...
type NullableOrganizationsOrganizationProjectsPostRequest struct {
	value *OrganizationsOrganizationProjectsPostRequest
	isSet bool
}

func (v NullableOrganizationsOrganizationProjectsPostRequest) Get() *OrganizationsOrganizationProjectsPostRequest {
	return v.value
}

func (v *NullableOrganizationsOrganizationProjectsPostRequest) Set(val *OrganizationsOrganizationProjectsPostRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableOrganizationsOrganizationProjectsPostRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableOrganizationsOrganizationProjectsPostRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableOrganizationsOrganizationProjectsPostRequest(val *OrganizationsOrganizationProjectsPostRequest) *NullableOrganizationsOrganizationProjectsPostRequest {
	return &NullableOrganizationsOrganizationProjectsPostRequest{value: val, isSet: true}
}

func (v NullableOrganizationsOrganizationProjectsPostRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableOrganizationsOrganizationProjectsPostRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
