...
// GetEnvironmentNames returns the EnvironmentNames field value if set, zero value otherwise (both if not set or set to explicit null).
...
func (o Application) ToMap() (map[string]interface{}, error) {
	...
	if o.EnvironmentNames != nil {
		toSerialize["environmentNames"] = o.EnvironmentNames
	}
...
func (o *Application) UnmarshalJSON(data []byte) (err error) {
	...
	*o = Application(varApplication)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "environmentNames")
