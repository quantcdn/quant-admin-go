...
// checks if the ProjectRequestUpdate type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ProjectRequestUpdate{}

// ProjectRequestUpdate struct for ProjectRequestUpdate
...
func (o ProjectRequestUpdate) MarshalJSON() ([]byte, error) {
...
func (o ProjectRequestUpdate) ToMap() (map[string]interface{}, error) {
...
type NullableProjectRequestUpdate struct {
	value *ProjectRequestUpdate
	isSet bool
}

func (v NullableProjectRequestUpdate) Get() *ProjectRequestUpdate {
	return v.value
}

func (v *NullableProjectRequestUpdate) Set(val *ProjectRequestUpdate) {
	v.value = val
	v.isSet = true
}

func (v NullableProjectRequestUpdate) IsSet() bool {
	return v.isSet
}

func (v *NullableProjectRequestUpdate) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableProjectRequestUpdate(val *ProjectRequestUpdate) *NullableProjectRequestUpdate {
	return &NullableProjectRequestUpdate{value: val, isSet: true}
}

func (v NullableProjectRequestUpdate) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableProjectRequestUpdate) UnmarshalJSON(src []byte) error {
	v.isSet = true
