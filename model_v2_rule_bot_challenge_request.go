...
// checks if the V2RuleBotChallengeRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &V2RuleBotChallengeRequest{}

// V2RuleBotChallengeRequest struct for V2RuleBotChallengeRequest
type V2RuleBotChallengeRequest struct {
...
type _V2RuleBotChallengeRequest V2RuleBotChallengeRequest
...
func (o V2RuleBotChallengeRequest) MarshalJSON() ([]byte, error) {
...
func (o V2RuleBotChallengeRequest) ToMap() (map[string]interface{}, error) {
...
func (o *V2RuleBotChallengeRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varV2RuleBotChallengeRequest := _V2RuleBotChallengeRequest{}

	err = json.Unmarshal(data, &varV2RuleBotChallengeRequest)

	if err != nil {
		return err
	}

	*o = V2RuleBotChallengeRequest(varV2RuleBotChallengeRequest)
...
type NullableV2RuleBotChallengeRequest struct {
	value *V2RuleBotChallengeRequest
	isSet bool
}

func (v NullableV2RuleBotChallengeRequest) Get() *V2RuleBotChallengeRequest {
	return v.value
}

func (v *NullableV2RuleBotChallengeRequest) Set(val *V2RuleBotChallengeRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableV2RuleBotChallengeRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableV2RuleBotChallengeRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableV2RuleBotChallengeRequest(val *V2RuleBotChallengeRequest) *NullableV2RuleBotChallengeRequest {
	return &NullableV2RuleBotChallengeRequest{value: val, isSet: true}
}

func (v NullableV2RuleBotChallengeRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableV2RuleBotChallengeRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
