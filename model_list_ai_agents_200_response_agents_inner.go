...
// GetHasOverlay returns the HasOverlay field value if set, zero value otherwise.
func (o *ListAIAgents200ResponseAgentsInner) GetHasOverlay() bool {
	if o == nil || IsNil(o.HasOverlay) {
		var ret bool
		return ret
	}
	return *o.HasOverlay
...
// GetHasOverlayOk returns a tuple with the HasOverlay field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ListAIAgents200ResponseAgentsInner) GetHasOverlayOk() (*bool, bool) {
	if o == nil || IsNil(o.HasOverlay) {
		return nil, false
	}
	return o.HasOverlay, true
}
...
// SetHasOverlay gets a reference to the given bool and assigns it to the HasOverlay field.
...
func (o *ListAIAgents200ResponseAgentsInner) UnmarshalJSON(data []byte) (err error) {
	...
	*o = ListAIAgents200ResponseAgentsInner(varListAIAgents200ResponseAgentsInner)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "hasOverlay")
