...
type RulesAPI interface {
	...
	*/
	...
	/*
	RulesErrorPageCreate Create a custom error page rule

	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@param organization Organization identifier
	@param project Project identifier
	@return RulesAPIRulesErrorPageCreateRequest
	*/
	RulesErrorPageCreate(ctx context.Context, organization string, project string) RulesAPIRulesErrorPageCreateRequest

	// RulesErrorPageCreateExecute executes the request
	//  @return V2RuleErrorPage
	RulesErrorPageCreateExecute(r RulesAPIRulesErrorPageCreateRequest) (*V2RuleErrorPage, *http.Response, error)

	/*
	RulesErrorPageDelete Delete a custom error page rule

	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@param organization Organization identifier
	@param project Project identifier
	@param rule Rule identifier
	@return RulesAPIRulesErrorPageDeleteRequest
	*/
	RulesErrorPageDelete(ctx context.Context, organization string, project string, rule string) RulesAPIRulesErrorPageDeleteRequest

	// RulesErrorPageDeleteExecute executes the request
	RulesErrorPageDeleteExecute(r RulesAPIRulesErrorPageDeleteRequest) (*http.Response, error)

	/*
	RulesErrorPageList List custom error page rules

	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@param organization Organization identifier
	@param project Project identifier
	@return RulesAPIRulesErrorPageListRequest
	*/
	RulesErrorPageList(ctx context.Context, organization string, project string) RulesAPIRulesErrorPageListRequest

	// RulesErrorPageListExecute executes the request
	//  @return []V2RuleErrorPage
	RulesErrorPageListExecute(r RulesAPIRulesErrorPageListRequest) ([]V2RuleErrorPage, *http.Response, error)

	/*
	RulesErrorPageRead Get details of a custom error page rule

	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@param organization Organization identifier
	@param project Project identifier
	@param rule Rule identifier
	@return RulesAPIRulesErrorPageReadRequest
	*/
	RulesErrorPageRead(ctx context.Context, organization string, project string, rule string) RulesAPIRulesErrorPageReadRequest

	// RulesErrorPageReadExecute executes the request
	//  @return V2RuleErrorPage
	RulesErrorPageReadExecute(r RulesAPIRulesErrorPageReadRequest) (*V2RuleErrorPage, *http.Response, error)

	/*
	RulesErrorPageUpdate Update a custom error page rule

	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@param organization Organization identifier
	@param project Project identifier
	@param rule Rule identifier
	@return RulesAPIRulesErrorPageUpdateRequest
	*/
	RulesErrorPageUpdate(ctx context.Context, organization string, project string, rule string) RulesAPIRulesErrorPageUpdateRequest

	// RulesErrorPageUpdateExecute executes the request
	//  @return V2RuleErrorPage
	RulesErrorPageUpdateExecute(r RulesAPIRulesErrorPageUpdateRequest) (*V2RuleErrorPage, *http.Response, error)
...
type RulesAPIRulesErrorPageCreateRequest struct {
	ctx context.Context
	ApiService RulesAPI
	organization string
	project string
	v2RuleErrorPageRequest *V2RuleErrorPageRequest
}

func (r RulesAPIRulesErrorPageCreateRequest) V2RuleErrorPageRequest(v2RuleErrorPageRequest V2RuleErrorPageRequest) RulesAPIRulesErrorPageCreateRequest {
	r.v2RuleErrorPageRequest = &v2RuleErrorPageRequest
	return r
}

func (r RulesAPIRulesErrorPageCreateRequest) Execute() (*V2RuleErrorPage, *http.Response, error) {
	return r.ApiService.RulesErrorPageCreateExecute(r)
}
...
RulesErrorPageCreate Create a custom error page rule
 ...
 @return RulesAPIRulesErrorPageCreateRequest
*/
func (a *RulesAPIService) RulesErrorPageCreate(ctx context.Context, organization string, project string) RulesAPIRulesErrorPageCreateRequest {
	return RulesAPIRulesErrorPageCreateRequest{
		ApiService: a,
		ctx: ctx,
		organization: organization,
...
// Execute executes the request
//  @return V2RuleErrorPage
func (a *RulesAPIService) RulesErrorPageCreateExecute(r RulesAPIRulesErrorPageCreateRequest) (*V2RuleErrorPage, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *V2RuleErrorPage
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "RulesAPIService.RulesErrorPageCreate")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/v2/organizations/{organization}/projects/{project}/rules/error-page"
	localVarPath = strings.Replace(localVarPath, "{"+"organization"+"}", url.PathEscape(parameterValueToString(r.organization, "organization")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"project"+"}", url.PathEscape(parameterValueToString(r.project, "project")), -1)
	...
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.v2RuleErrorPageRequest == nil {
		return localVarReturnValue, nil, reportError("v2RuleErrorPageRequest is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.v2RuleErrorPageRequest
	req, err := a.client.prepareRequest(r.ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, formFiles)
	if err != nil {
		return localVarReturnValue, nil, err
	}
...
type RulesAPIRulesErrorPageDeleteRequest struct {
	ctx context.Context
	ApiService RulesAPI
	organization string
	project string
...
func (r RulesAPIRulesErrorPageDeleteRequest) Execute() (*http.Response, error) {
	return r.ApiService.RulesErrorPageDeleteExecute(r)
}
...
RulesErrorPageDelete Delete a custom error page rule
 ...
 @return RulesAPIRulesErrorPageDeleteRequest
*/
func (a *RulesAPIService) RulesErrorPageDelete(ctx context.Context, organization string, project string, rule string) RulesAPIRulesErrorPageDeleteRequest {
	return RulesAPIRulesErrorPageDeleteRequest{
		ApiService: a,
		ctx: ctx,
		organization: organization,
...
// Execute executes the request
func (a *RulesAPIService) RulesErrorPageDeleteExecute(r RulesAPIRulesErrorPageDeleteRequest) (*http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodDelete
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "RulesAPIService.RulesErrorPageDelete")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/v2/organizations/{organization}/projects/{project}/rules/error-page/{rule}"
	localVarPath = strings.Replace(localVarPath, "{"+"organization"+"}", url.PathEscape(parameterValueToString(r.organization, "organization")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"project"+"}", url.PathEscape(parameterValueToString(r.project, "project")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"rule"+"}", url.PathEscape(parameterValueToString(r.rule, "rule")), -1)
...
type RulesAPIRulesErrorPageListRequest struct {
	ctx context.Context
	ApiService RulesAPI
	organization string
	project string
...
func (r RulesAPIRulesErrorPageListRequest) Execute() ([]V2RuleErrorPage, *http.Response, error) {
	return r.ApiService.RulesErrorPageListExecute(r)
}
...
RulesErrorPageList List custom error page rules
 ...
 @return RulesAPIRulesErrorPageListRequest
*/
func (a *RulesAPIService) RulesErrorPageList(ctx context.Context, organization string, project string) RulesAPIRulesErrorPageListRequest {
	return RulesAPIRulesErrorPageListRequest{
		ApiService: a,
		ctx: ctx,
		organization: organization,
...
// Execute executes the request
//  @return []V2RuleErrorPage
func (a *RulesAPIService) RulesErrorPageListExecute(r RulesAPIRulesErrorPageListRequest) ([]V2RuleErrorPage, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "RulesAPIService.RulesErrorPageList")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
type RulesAPIRulesErrorPageReadRequest struct {
	ctx context.Context
	ApiService RulesAPI
	organization string
	project string
...
func (r RulesAPIRulesErrorPageReadRequest) Execute() (*V2RuleErrorPage, *http.Response, error) {
	return r.ApiService.RulesErrorPageReadExecute(r)
}
...
RulesErrorPageRead Get details of a custom error page rule
 ...
 @return RulesAPIRulesErrorPageReadRequest
*/
func (a *RulesAPIService) RulesErrorPageRead(ctx context.Context, organization string, project string, rule string) RulesAPIRulesErrorPageReadRequest {
	return RulesAPIRulesErrorPageReadRequest{
		ApiService: a,
		ctx: ctx,
		organization: organization,
...
// Execute executes the request
//  @return V2RuleErrorPage
func (a *RulesAPIService) RulesErrorPageReadExecute(r RulesAPIRulesErrorPageReadRequest) (*V2RuleErrorPage, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "RulesAPIService.RulesErrorPageRead")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
type RulesAPIRulesErrorPageUpdateRequest struct {
	ctx context.Context
	ApiService RulesAPI
	organization string
	project string
...
func (r RulesAPIRulesErrorPageUpdateRequest) V2RuleErrorPageRequest(v2RuleErrorPageRequest V2RuleErrorPageRequest) RulesAPIRulesErrorPageUpdateRequest {
	r.v2RuleErrorPageRequest = &v2RuleErrorPageRequest
	return r
}

func (r RulesAPIRulesErrorPageUpdateRequest) Execute() (*V2RuleErrorPage, *http.Response, error) {
	return r.ApiService.RulesErrorPageUpdateExecute(r)
}
...
RulesErrorPageUpdate Update a custom error page rule
 ...
 @return RulesAPIRulesErrorPageUpdateRequest
*/
func (a *RulesAPIService) RulesErrorPageUpdate(ctx context.Context, organization string, project string, rule string) RulesAPIRulesErrorPageUpdateRequest {
	return RulesAPIRulesErrorPageUpdateRequest{
		ApiService: a,
		ctx: ctx,
		organization: organization,
...
// Execute executes the request
//  @return V2RuleErrorPage
func (a *RulesAPIService) RulesErrorPageUpdateExecute(r RulesAPIRulesErrorPageUpdateRequest) (*V2RuleErrorPage, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPatch
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "RulesAPIService.RulesErrorPageUpdate")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
