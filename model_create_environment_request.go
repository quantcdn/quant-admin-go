...
type CreateEnvironmentRequest struct {
	...
	// Optional. Forces single-task mode (max one running task). When omitted, the platform auto-detects stateful containers.
	SingleTaskOnly NullableBool `json:"singleTaskOnly,omitempty"`
	// Optional. Seconds the load balancer waits after a task starts before an unhealthy health check can replace it. If not set, the value from composeDefinition (or default 120) is used.
...
func (o *CreateEnvironmentRequest) SetSingleTaskOnlyNil() {
...
func (o *CreateEnvironmentRequest) SetStartupGracePeriodSecondsNil() {
