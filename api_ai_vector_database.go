...
type AIVectorDatabaseAPI interface {
	...
	*/
	...
	DeleteVectorCollectionExecute(r AIVectorDatabaseAPIDeleteVectorCollectionRequest) (*DeleteSkillCollection200Response, *http.Response, error)
	...
	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@param organisation Organisation machine name
	@param collectionId Collection UUID
	@return AIVectorDatabaseAPIDeleteVectorDocumentsRequest
	*/
	DeleteVectorDocuments(ctx context.Context, organisation string, collectionId string) AIVectorDatabaseAPIDeleteVectorDocumentsRequest

	// DeleteVectorDocumentsExecute executes the request
	//  @return DeleteVectorDocuments200Response
	DeleteVectorDocumentsExecute(r AIVectorDatabaseAPIDeleteVectorDocumentsRequest) (*DeleteVectorDocuments200Response, *http.Response, error)
...
func (r AIVectorDatabaseAPIDeleteVectorCollectionRequest) Execute() (*DeleteSkillCollection200Response, *http.Response, error) {
...
// Execute executes the request
//  @return DeleteSkillCollection200Response
func (a *AIVectorDatabaseAPIService) DeleteVectorCollectionExecute(r AIVectorDatabaseAPIDeleteVectorCollectionRequest) (*DeleteSkillCollection200Response, *http.Response, error) {
	var (
...
type AIVectorDatabaseAPIDeleteVectorDocumentsRequest struct {
	ctx context.Context
	ApiService AIVectorDatabaseAPI
	organisation string
	collectionId string
...
func (r AIVectorDatabaseAPIDeleteVectorDocumentsRequest) DeleteVectorDocumentsRequest(deleteVectorDocumentsRequest DeleteVectorDocumentsRequest) AIVectorDatabaseAPIDeleteVectorDocumentsRequest {
	r.deleteVectorDocumentsRequest = &deleteVectorDocumentsRequest
	return r
}

func (r AIVectorDatabaseAPIDeleteVectorDocumentsRequest) Execute() (*DeleteVectorDocuments200Response, *http.Response, error) {
	return r.ApiService.DeleteVectorDocumentsExecute(r)
}
...
Delete documents from a collection. Supports three deletion modes:
 ...
 @return AIVectorDatabaseAPIDeleteVectorDocumentsRequest
*/
func (a *AIVectorDatabaseAPIService) DeleteVectorDocuments(ctx context.Context, organisation string, collectionId string) AIVectorDatabaseAPIDeleteVectorDocumentsRequest {
	return AIVectorDatabaseAPIDeleteVectorDocumentsRequest{
		ApiService: a,
		ctx: ctx,
		organisation: organisation,
...
// Execute executes the request
//  @return DeleteVectorDocuments200Response
func (a *AIVectorDatabaseAPIService) DeleteVectorDocumentsExecute(r AIVectorDatabaseAPIDeleteVectorDocumentsRequest) (*DeleteVectorDocuments200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodDelete
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *DeleteVectorDocuments200Response
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "AIVectorDatabaseAPIService.DeleteVectorDocuments")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
	...
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.deleteVectorDocumentsRequest == nil {
		return localVarReturnValue, nil, reportError("deleteVectorDocumentsRequest is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.deleteVectorDocumentsRequest
	req, err := a.client.prepareRequest(r.ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, formFiles)
	if err != nil {
		return localVarReturnValue, nil, err
	}
