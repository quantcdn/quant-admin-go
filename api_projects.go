...
type ProjectsAPI interface {
	...
	/*
	GetProjectLogs Get CDN access logs for a project
	...
	@param organization The organization machine name
	@param project The project machine name
	@return ProjectsAPIGetProjectLogsRequest
	*/
	GetProjectLogs(ctx context.Context, organization string, project string) ProjectsAPIGetProjectLogsRequest

	// GetProjectLogsExecute executes the request
	//  @return GetProjectLogs200Response
	GetProjectLogsExecute(r ProjectsAPIGetProjectLogsRequest) (*GetProjectLogs200Response, *http.Response, error)
...
type ProjectsAPIGetProjectLogsRequest struct {
	ctx context.Context
...
func (r ProjectsAPIGetProjectLogsRequest) Limit(limit int32) ProjectsAPIGetProjectLogsRequest {
	r.limit = &limit
	return r
}

// Start of the time range. ISO 8601 or Unix epoch milliseconds.
func (r ProjectsAPIGetProjectLogsRequest) StartTime(startTime string) ProjectsAPIGetProjectLogsRequest {
	r.startTime = &startTime
	return r
}

// End of the time range. ISO 8601 or Unix epoch milliseconds.
func (r ProjectsAPIGetProjectLogsRequest) EndTime(endTime string) ProjectsAPIGetProjectLogsRequest {
	r.endTime = &endTime
	return r
}
...
func (r ProjectsAPIGetProjectLogsRequest) Filter(filter string) ProjectsAPIGetProjectLogsRequest {
	r.filter = &filter
	return r
}

// Only return entries for this domain
func (r ProjectsAPIGetProjectLogsRequest) Domain(domain string) ProjectsAPIGetProjectLogsRequest {
	r.domain = &domain
	return r
}

// Opaque pagination token from the previous response. Pass back unchanged to fetch the next page.
func (r ProjectsAPIGetProjectLogsRequest) NextToken(nextToken string) ProjectsAPIGetProjectLogsRequest {
	r.nextToken = &nextToken
	return r
}

func (r ProjectsAPIGetProjectLogsRequest) Execute() (*GetProjectLogs200Response, *http.Response, error) {
...
Retrieves CloudFront access log entries for an AWS-platform project. Results are always scoped to the project; the optional filter can only narrow them. Entries are returned oldest first; pass nextToken from the previous response to fetch the next page. Logs are retained for 30 days.
 ...
 @return ProjectsAPIGetProjectLogsRequest
*/
func (a *ProjectsAPIService) GetProjectLogs(ctx context.Context, organization string, project string) ProjectsAPIGetProjectLogsRequest {
	return ProjectsAPIGetProjectLogsRequest{
		ApiService: a,
		ctx: ctx,
...
//  @return GetProjectLogs200Response
func (a *ProjectsAPIService) GetProjectLogsExecute(r ProjectsAPIGetProjectLogsRequest) (*GetProjectLogs200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *GetProjectLogs200Response
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ProjectsAPIService.GetProjectLogs")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/v2/organizations/{organization}/projects/{project}/logs"
	...
	if localVarHTTPResponse.StatusCode >= 300 {
		...
		if localVarHTTPResponse.StatusCode == 400 {
			var v GetProjectLogs400Response
