...
`func (o *V2RuleRedirect) SetCacheLifetimeNil(b bool)`
...
`func (o *V2RuleRedirect) SetInjectHeadersNil(b bool)`

 SetInjectHeadersNil sets the value for InjectHeaders to be an explicit nil

### UnsetInjectHeaders
`func (o *V2RuleRedirect) UnsetInjectHeaders()`
...
`func (o *V2RuleRedirect) SetNotifyConfigNil(b bool)`
...
`func (o *V2RuleRedirect) SetQuantCloudSelectionNil(b bool)`
