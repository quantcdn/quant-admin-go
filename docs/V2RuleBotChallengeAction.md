...
`func (o *V2RuleBotChallengeAction) SetCacheLifetimeNil(b bool)`
...
`func (o *V2RuleBotChallengeAction) SetInjectHeadersNil(b bool)`

 SetInjectHeadersNil sets the value for InjectHeaders to be an explicit nil

### UnsetInjectHeaders
`func (o *V2RuleBotChallengeAction) UnsetInjectHeaders()`
...
`func (o *V2RuleBotChallengeAction) SetNotifyConfigNil(b bool)`
...
`func (o *V2RuleBotChallengeAction) SetQuantCloudSelectionNil(b bool)`
