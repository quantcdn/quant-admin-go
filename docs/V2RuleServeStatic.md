...
`func NewV2RuleServeStatic(message string, error_ bool, uuid string, disabled bool, action string, to string, actionConfig V2RuleServeStaticAction, ) *V2RuleServeStatic`
...
`func (o *V2RuleServeStatic) GetMessage() string`

GetMessage returns the Message field if non-nil, zero value otherwise.

### GetMessageOk

`func (o *V2RuleServeStatic) GetMessageOk() (*string, bool)`
...
`func (o *V2RuleServeStatic) SetMessage(v string)`
...
`func (o *V2RuleServeStatic) GetError() bool`

GetError returns the Error field if non-nil, zero value otherwise.

### GetErrorOk

`func (o *V2RuleServeStatic) GetErrorOk() (*bool, bool)`
...
`func (o *V2RuleServeStatic) SetError(v bool)`
...
`func (o *V2RuleServeStatic) GetTo() string`

GetTo returns the To field if non-nil, zero value otherwise.

### GetToOk

`func (o *V2RuleServeStatic) GetToOk() (*string, bool)`
...
`func (o *V2RuleServeStatic) SetTo(v string)`
...
`func (o *V2RuleServeStatic) GetHost() string`

GetHost returns the Host field if non-nil, zero value otherwise.

### GetHostOk

`func (o *V2RuleServeStatic) GetHostOk() (*string, bool)`
...
`func (o *V2RuleServeStatic) SetHost(v string)`

SetHost sets Host field to given value.

### HasHost

`func (o *V2RuleServeStatic) HasHost() bool`

HasHost returns a boolean if a field has been set.

### GetAuthUser

`func (o *V2RuleServeStatic) GetAuthUser() string`

GetAuthUser returns the AuthUser field if non-nil, zero value otherwise.

### GetAuthUserOk

`func (o *V2RuleServeStatic) GetAuthUserOk() (*string, bool)`
...
`func (o *V2RuleServeStatic) SetAuthUser(v string)`

SetAuthUser sets AuthUser field to given value.

### HasAuthUser

`func (o *V2RuleServeStatic) HasAuthUser() bool`

HasAuthUser returns a boolean if a field has been set.

### GetAuthPass

`func (o *V2RuleServeStatic) GetAuthPass() string`

GetAuthPass returns the AuthPass field if non-nil, zero value otherwise.

### GetAuthPassOk

`func (o *V2RuleServeStatic) GetAuthPassOk() (*string, bool)`
...
`func (o *V2RuleServeStatic) SetDisableSslVerify(v bool)`

SetDisableSslVerify sets DisableSslVerify field to given value.

### HasDisableSslVerify

`func (o *V2RuleServeStatic) HasDisableSslVerify() bool`

HasDisableSslVerify returns a boolean if a field has been set.

### GetCacheLifetime

`func (o *V2RuleServeStatic) GetCacheLifetime() string`

GetCacheLifetime returns the CacheLifetime field if non-nil, zero value otherwise.

### GetCacheLifetimeOk

`func (o *V2RuleServeStatic) GetCacheLifetimeOk() (*string, bool)`
...
`func (o *V2RuleServeStatic) SetOnlyProxy404(v bool)`

SetOnlyProxy404 sets OnlyProxy404 field to given value.

### HasOnlyProxy404

`func (o *V2RuleServeStatic) HasOnlyProxy404() bool`

HasOnlyProxy404 returns a boolean if a field has been set.

### GetInjectHeaders

`func (o *V2RuleServeStatic) GetInjectHeaders() map[string]string`

GetInjectHeaders returns the InjectHeaders field if non-nil, zero value otherwise.

### GetInjectHeadersOk

`func (o *V2RuleServeStatic) GetInjectHeadersOk() (*map[string]string, bool)`
...
`func (o *V2RuleServeStatic) GetProxyStripRequestHeadersOk() (*[]string, bool)`
...
`func (o *V2RuleServeStatic) SetOriginTimeout(v string)`

SetOriginTimeout sets OriginTimeout field to given value.

### HasOriginTimeout

`func (o *V2RuleServeStatic) HasOriginTimeout() bool`

HasOriginTimeout returns a boolean if a field has been set.

### GetFailoverMode

`func (o *V2RuleServeStatic) GetFailoverMode() bool`

GetFailoverMode returns the FailoverMode field if non-nil, zero value otherwise.

### GetFailoverModeOk

`func (o *V2RuleServeStatic) GetFailoverModeOk() (*bool, bool)`
...
`func (o *V2RuleServeStatic) GetFailoverOriginStatusCodesOk() (*[]string, bool)`
...
`func (o *V2RuleServeStatic) SetFailoverLifetime(v string)`

SetFailoverLifetime sets FailoverLifetime field to given value.

### HasFailoverLifetime

`func (o *V2RuleServeStatic) HasFailoverLifetime() bool`

HasFailoverLifetime returns a boolean if a field has been set.

### GetNotify

`func (o *V2RuleServeStatic) GetNotify() string`

GetNotify returns the Notify field if non-nil, zero value otherwise.

### GetNotifyOk

`func (o *V2RuleServeStatic) GetNotifyOk() (*string, bool)`
...
`func (o *V2RuleServeStatic) SetNotify(v string)`

SetNotify sets Notify field to given value.

### HasNotify

`func (o *V2RuleServeStatic) HasNotify() bool`

HasNotify returns a boolean if a field has been set.

### GetNotifyConfig

`func (o *V2RuleServeStatic) GetNotifyConfig() V2RuleProxyActionAllOfNotifyConfig`

GetNotifyConfig returns the NotifyConfig field if non-nil, zero value otherwise.

### GetNotifyConfigOk

`func (o *V2RuleServeStatic) GetNotifyConfigOk() (*V2RuleProxyActionAllOfNotifyConfig, bool)`
...
`func (o *V2RuleServeStatic) SetWafEnabled(v bool)`

SetWafEnabled sets WafEnabled field to given value.

### HasWafEnabled

`func (o *V2RuleServeStatic) HasWafEnabled() bool`

HasWafEnabled returns a boolean if a field has been set.

### GetWafConfig

`func (o *V2RuleServeStatic) GetWafConfig() WafConfig`

GetWafConfig returns the WafConfig field if non-nil, zero value otherwise.

### GetWafConfigOk

`func (o *V2RuleServeStatic) GetWafConfigOk() (*WafConfig, bool)`
