...
**Workers** | Pointer to **int32** | Number of concurrent workers (verified domains only) | [optional] 
**Delay** | Pointer to **float32** | Delay between requests in seconds (verified domains only) | [optional] 
**Depth** | Pointer to **int32** | Maximum crawl depth, -1 for unlimited (verified domains only) | [optional] 
**MaxHits** | Pointer to **int32** | Maximum total requests, 0 for unlimited (verified domains only) | [optional] 
**MaxHtml** | Pointer to **int32** | Maximum HTML pages, 0 for unlimited (verified domains only) | [optional] 
**StatusOk** | Pointer to **[]int32** | HTTP status codes that will result in content being captured and pushed to Quant (verified domains only) | [optional] 
**Sitemap** | Pointer to **[]map[string]interface{}** | Sitemap configuration (verified domains only) | [optional] 
**AllowedDomains** | Pointer to **[]string** | Allowed domains for multi-domain crawling, automatically enables merge_domains (verified domains only) | [optional] 
**UserAgent** | Pointer to **string** | Custom user agent, only when browser_mode is false (verified domains only) | [optional] 
**Assets** | Pointer to **map[string]interface{}** | Asset harvesting configuration (verified domains only) | [optional] 
**MaxErrors** | Pointer to **int32** | Maximum errors before stopping crawl (verified domains only) | [optional] 
