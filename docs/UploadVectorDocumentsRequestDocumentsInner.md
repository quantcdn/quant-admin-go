...
**Key** | Pointer to **string** | Stable document key for upsert | [optional] 
...
`func (o *UploadVectorDocumentsRequestDocumentsInner) GetKey() string`

GetKey returns the Key field if non-nil, zero value otherwise.

### GetKeyOk

`func (o *UploadVectorDocumentsRequestDocumentsInner) GetKeyOk() (*string, bool)`
...
`func (o *UploadVectorDocumentsRequestDocumentsInner) SetKey(v string)`

SetKey sets Key field to given value.

### HasKey

`func (o *UploadVectorDocumentsRequestDocumentsInner) HasKey() bool`
