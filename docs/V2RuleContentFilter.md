...
`func (o *V2RuleContentFilter) SetCacheLifetimeNil(b bool)`
...
`func (o *V2RuleContentFilter) SetInjectHeadersNil(b bool)`

 SetInjectHeadersNil sets the value for InjectHeaders to be an explicit nil

### UnsetInjectHeaders
`func (o *V2RuleContentFilter) UnsetInjectHeaders()`
...
`func (o *V2RuleContentFilter) SetNotifyConfigNil(b bool)`
...
`func (o *V2RuleContentFilter) SetQuantCloudSelectionNil(b bool)`
