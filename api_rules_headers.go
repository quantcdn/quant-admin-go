...
type ApiRulesHeadersUpdateRequest struct {
	ctx context.Context
	ApiService *RulesHeadersAPIService
	organization string
	project string
...
func (r ApiRulesHeadersUpdateRequest) RuleHeaderRequest(ruleHeaderRequest RuleHeaderRequest) ApiRulesHeadersUpdateRequest {
	r.ruleHeaderRequest = &ruleHeaderRequest
	return r
}
...
/*
RulesHeadersUpdate Method for RulesHeadersUpdate

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param organization
 @param project
 @param rule
 @return ApiRulesHeadersUpdateRequest
*/
func (a *RulesHeadersAPIService) RulesHeadersUpdate(ctx context.Context, organization string, project string, rule string) ApiRulesHeadersUpdateRequest {
	return ApiRulesHeadersUpdateRequest{
		ApiService: a,
		ctx: ctx,
		organization: organization,
