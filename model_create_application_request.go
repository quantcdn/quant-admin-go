...
type CreateApplicationRequest struct {
	...
	Environment []CreateApplicationRequestEnvironmentInner `json:"environment,omitempty"`
...
func (o *CreateApplicationRequest) GetEnvironment() []CreateApplicationRequestEnvironmentInner {
	if o == nil {
		var ret []CreateApplicationRequestEnvironmentInner
		return ret
	}
...
// SetEnvironment gets a reference to the given []CreateApplicationRequestEnvironmentInner and assigns it to the Environment field.
