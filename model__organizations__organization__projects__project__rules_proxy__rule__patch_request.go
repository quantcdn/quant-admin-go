...
// checks if the OrganizationsOrganizationProjectsProjectRulesProxyRulePatchRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &OrganizationsOrganizationProjectsProjectRulesProxyRulePatchRequest{}

// OrganizationsOrganizationProjectsProjectRulesProxyRulePatchRequest struct for OrganizationsOrganizationProjectsProjectRulesProxyRulePatchRequest
type OrganizationsOrganizationProjectsProjectRulesProxyRulePatchRequest struct {
	...
	WafConfig *OrganizationsOrganizationProjectsProjectRulesProxyRulePatchRequestWafConfig `json:"waf_config,omitempty"`
}
...
func NewOrganizationsOrganizationProjectsProjectRulesProxyRulePatchRequest() *OrganizationsOrganizationProjectsProjectRulesProxyRulePatchRequest {
	this := OrganizationsOrganizationProjectsProjectRulesProxyRulePatchRequest{}
	return &this
}
...
func (o *OrganizationsOrganizationProjectsProjectRulesProxyRulePatchRequest) GetWafConfig() OrganizationsOrganizationProjectsProjectRulesProxyRulePatchRequestWafConfig {
	if o == nil || IsNil(o.WafConfig) {
		var ret OrganizationsOrganizationProjectsProjectRulesProxyRulePatchRequestWafConfig
		return ret
	}
	return *o.WafConfig
}
...
// SetWafConfig gets a reference to the given OrganizationsOrganizationProjectsProjectRulesProxyRulePatchRequestWafConfig and assigns it to the WafConfig field.
...
func (o OrganizationsOrganizationProjectsProjectRulesProxyRulePatchRequest) MarshalJSON() ([]byte, error) {
...
func (o OrganizationsOrganizationProjectsProjectRulesProxyRulePatchRequest) ToMap() (map[string]interface{}, error) {
...
type NullableOrganizationsOrganizationProjectsProjectRulesProxyRulePatchRequest struct {
	value *OrganizationsOrganizationProjectsProjectRulesProxyRulePatchRequest
	isSet bool
}

func (v NullableOrganizationsOrganizationProjectsProjectRulesProxyRulePatchRequest) Get() *OrganizationsOrganizationProjectsProjectRulesProxyRulePatchRequest {
	return v.value
}

func (v *NullableOrganizationsOrganizationProjectsProjectRulesProxyRulePatchRequest) Set(val *OrganizationsOrganizationProjectsProjectRulesProxyRulePatchRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableOrganizationsOrganizationProjectsProjectRulesProxyRulePatchRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableOrganizationsOrganizationProjectsProjectRulesProxyRulePatchRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableOrganizationsOrganizationProjectsProjectRulesProxyRulePatchRequest(val *OrganizationsOrganizationProjectsProjectRulesProxyRulePatchRequest) *NullableOrganizationsOrganizationProjectsProjectRulesProxyRulePatchRequest {
	return &NullableOrganizationsOrganizationProjectsProjectRulesProxyRulePatchRequest{value: val, isSet: true}
}

func (v NullableOrganizationsOrganizationProjectsProjectRulesProxyRulePatchRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableOrganizationsOrganizationProjectsProjectRulesProxyRulePatchRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
